...
class CompletedCourseCard extends StatefulWidget {
  const CompletedCourseCard({required this.course, Key? key}) : super(key: key);
  final Course course;

  @override
  State<CompletedCourseCard> createState() => _CompletedCourseCardState();
}

class _CompletedCourseCardState extends State<CompletedCourseCard> {
